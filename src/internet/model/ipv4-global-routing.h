...
class Ipv4GlobalRouting : public Ipv4RoutingProtocol
{
  public:
     ...
     * \return the number of stream indices assigned byq this model
     */
  ...
  private:
     ...
     */
    Ptr<Ipv4Route> LookupGlobal(const Ipv4Header &header, Ptr<const Packet> p, Ptr<NetDevice> oif = nullptr);
